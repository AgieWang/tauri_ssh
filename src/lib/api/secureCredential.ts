...
export const secureCredentialApi = {
  ...
  listAuditLogs: (input?: ListSecureCredentialAuditLogsInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialAuditLog[]>(
          "list_secure_credential_audit_logs",
          { input },
        )
      : devApiFetch<SecureCredentialAuditLog[]>(
          "/secure-credentials/audit-logs",
          {
            method: "POST",
            body: JSON.stringify(input ?? null),
          },
  ...
  delete: (credentialKey: string) =>
    hasTauriRuntime()
      ...
      : devApiFetch<void>(
          `/secure-credentials/${encodeURIComponent(credentialKey)}`,
          {
            method: "DELETE",
          },
        ),
  listSessions: (input?: ListSecureCredentialSessionsInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialSession[]>("list_secure_credential_sessions", {
          input,
        })
      : devApiFetch<SecureCredentialSession[]>(
          "/secure-credentials/sessions/list",
          {
            method: "POST",
            body: JSON.stringify(input ?? null),
          },
  ...
  createSession: (input: CreateSecureCredentialSessionInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialSession>("create_secure_credential_session", {
          input,
        })
  ...
  sessionStatus: (sessionId: string) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialSessionStatus>(
          "get_secure_credential_session_status",
          { sessionId },
        )
  ...
  revokeSession: (sessionId: string) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialSession>("revoke_secure_credential_session", {
          sessionId,
        })
      : devApiFetch<SecureCredentialSession>(
  ...
  testProvider: (input: SecureCredentialProviderTestInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialProviderTestResult>(
          "test_secure_credential_provider",
          { input },
        )
      : devApiFetch<SecureCredentialProviderTestResult>(
          "/secure-credentials/provider/test",
          {
            method: "POST",
            body: JSON.stringify(input),
          },
  ...
  listRepositories: (input: SecureCredentialRepositoryListInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialRepository[]>(
          "list_secure_credential_repositories",
          { input },
        )
      : devApiFetch<SecureCredentialRepository[]>(
          "/secure-credentials/provider/repositories",
          {
            method: "POST",
            body: JSON.stringify(input),
          },
  ...
  gitReadonlyRequest: (input: SecureCredentialGitReadInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialProviderReadResult>(
          "secure_credential_git_readonly_request",
          {
            input,
          },
        )
  ...
  httpReadonlyRequest: (input: SecureCredentialHttpRequestInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialHttpRequestResult>(
          "secure_credential_http_readonly_request",
          {
            input,
          },
        )
  ...
  httpWriteRequest: (input: SecureCredentialHttpWriteInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialHttpRequestResult>(
          "secure_credential_http_write_request",
          {
            input,
          },
        )
      : devApiFetch<SecureCredentialHttpRequestResult>(
          "/secure-credentials/provider/http-write",
          {
            method: "POST",
            body: JSON.stringify(input),
          },
  ...
  executeGitWrite: (input: SecureCredentialGitWriteInput) =>
    hasTauriRuntime()
      ? invoke<SecureCredentialGitWriteResult>(
          "execute_secure_credential_git_write",
          {
            input,
          },
        )
      : devApiFetch<SecureCredentialGitWriteResult>(
          "/secure-credentials/provider/git-write",
          {
            method: "POST",
            body: JSON.stringify(input),
          },
