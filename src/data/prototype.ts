...
export const coverageRows: CoverageRecord[] = [
  { feature: "启动引导", page: "启动引导", status: "覆盖" },
  { feature: "服务器分组管理", page: "服务器管理", status: "覆盖" },
  { feature: "~/.ssh/config 导入", page: "SSH Config 导入", status: "覆盖" },
  { feature: "SQLite 加密凭据字段", page: "凭据保险库", status: "覆盖" },
  { feature: "命令行 AI 问答", page: "终端 + AI", status: "覆盖" },
  { feature: "AI 权限控制", page: "审批队列", status: "覆盖" },
  { feature: "多标签日志监听", page: "日志监听", status: "覆盖" },
  { feature: "日志搜索与过滤", page: "日志监听", status: "覆盖" },
  { feature: "SFTP 上传下载", page: "SFTP 文件", status: "覆盖" },
  { feature: "SFTP 内置文本编辑器", page: "文本编辑器", status: "覆盖" },
  { feature: "多 AI Provider", page: "AI Provider", status: "覆盖" },
  { feature: "本应用作为 MCP Server", page: "MCP Server", status: "覆盖" },
  { feature: "JumpServer 会话兼容", page: "堡垒机会话", status: "覆盖" },
  { feature: "审计日志", page: "审计日志", status: "覆盖" },
  { feature: "团队字段预留", page: "团队预留", status: "覆盖" },
  { feature: "空状态和错误状态", page: "状态页", status: "覆盖" },
  { feature: "macOS / Windows 首发", page: "系统设置", status: "覆盖" },
];
