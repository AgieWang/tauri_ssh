...
function Home() {
  return (
    <div className="mobile-home">
      ...
      <ul>
        <li>
          桌面端起 axum 远程网关：见 <code>src-tauri/src/remote/</code>
        </li>
        <li>
          移动端走 fetch / WebSocket：见 <code>src/mobile/lib/api.ts</code> +{" "}
          <code>ws.ts</code>
        </li>
        <li>
          新增页面：在 <code>src/mobile/pages/</code> 下创建组件并到{" "}
          <code>MobileApp.tsx</code> 注册路由
        </li>
      </ul>
    </div>
  );
